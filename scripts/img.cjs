...
const WIDTHS = {
  ...
  logo: [151, 302, 453],
  card: [110, 220, 330],
  notification: [338, 676, 1014],
  certificate: [338, 676, 1014],
  // level: [160, 320, 480],
};
const GROUPS = [
  { name: "logo", test: /(logo)/i, widths: WIDTHS.logo },
  { name: "card", test: /(card)/i, widths: WIDTHS.card },
  { name: "notification", test: /(notification)/i, widths: WIDTHS.notification },
  { name: "certificate", test: /(certificate)/i, widths: WIDTHS.certificate },
  // { name: "level", test: /(level)/i, widths: WIDTHS.level }
];
